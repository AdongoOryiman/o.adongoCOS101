...
//About Electrical/Electronic
    ...
    println! ("\nThe {} is informed by the aspiration to train electrical/electronic engineering professionals in the areas off design, building and maintenance of electrical control systems. " , n4);
