...
fn main() {
    ...
    let header_1 = "Below is our rich portfolio of lager drinks;\n";
    let header_2 = "Below is our rich portfolio of stout drinks;\n";
    ...
    file.write_all(header_1.as_bytes()).expect("write failed");
    for x in exp.iter() {
